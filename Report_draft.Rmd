...
author: "Jinfei Xue, Janhao Yan, Si Chen"
date: "Oct 27 2018"
output:
...
The green leaf dataset mainly includes the following variables:

- Year: The year when sample collected
- Month: The month when sample collected
- Species: Tree species of leaf. ACRU = Acer rubrum (red maple); QURU = Quercus rubra (red oak)
