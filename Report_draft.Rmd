...
If samples are collected in June, then $\textbf{$Month_{7}$}$ and $\textbf{$Month_{8}$}$ are both equal to 0; If samples are collected in July, then $\textbf{$Month_{7}$}$ equal to 1 but $\textbf{$Month_{8}$}$ equals to 0; If samples are collected in August, then $\textbf{$Month_{8}$}$ equal to 1 but $\textbf{$Month_{7}$}$ equals to 0.

$\textbf{$QURU\times Months$}$ equals to the value of $\textbf{Months}$ when samples are from QURU tree leaves(because $\textbf{QURU}$ equals to 1 in this case). However, $\textbf{$QURU\times Months$}$ equals to 0 when samples are from ACRU tree leaves(because $\textbf{QURU}$ equals to 0 in this case). 
