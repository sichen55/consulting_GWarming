...
Global warming has become a significant topic in the ecosystem field. It’s worthwhile to study in the effects which global warming has brought about. Therefore, a long-term ecosystem warming experiment was established at Harvard Forest (Petersham, MA) in 2002. In this experiment, two 30 x 30 meter plots were established. One plot is continuously heated to 5 degrees Celsius above ambient temperature, while the other plot is left as a control. A wide variety of ecological response variables have been measured over the course of the experiment. The data were collected from 2002 to 2016 in different time intervals.
